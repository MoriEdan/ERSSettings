...
namespace ERSSettings.Customisations
{
    internal static class CustomisationConstants
    {
        ...
        internal const string _318_SERVICE_MANAGER_GUID = "7971f918-a847-4430-9279-4a52d1efe18d";
        internal const string _318_UPDATE_SERVICE_MANAGER = "Microsoft.Update.ServiceManager";
        internal const string _320_HIGH_POWER_ARGS = "/SETACTIVE SCHEME_MIN";
        internal const string _320_HIGH_POWER_GUID = "{8c5e7fda-e8bf-4a96-9a85-a6e23a8c635c}";
        internal const string _321_BALANCED_POWER_ARGS = "/SETACTIVE SCHEME_BALANCED";
        internal const string _322_NET_FRAMEWORK32_PATH = @"SOFTWARE\Wow6432Node\Microsoft\.NETFramework";
        internal const string _322_NET_FRAMEWORK64_PATH = @"SOFTWARE\Microsoft\.NETFramework";
        internal const string _322_USE_LATEST_CLR = "OnlyUseLatestCLR";
        internal const string _328_DESKTOP_FOLDER = "Desktop";
        internal const byte _331_AUTOMATICALLY_VALUE = 3;
        internal const byte _332_DEFAULT_VALUE = 2;
        internal const string _333_SEPARATE_PROCESS = "SeparateProcess";
        internal const string _334_RESERVE_MANAGER_PATH = @"SOFTWARE\Microsoft\Windows\CurrentVersion\ReserveManager";
        internal const string _334_SHIPPED_RESERVES = "ShippedWithReserves";
        internal const string _335_TYPELIB_PATH = @"SOFTWARE\Classes\Typelib\{8cec5860-07a1-11d9-b15e-000d56bfe6ee}";
        internal const string _335_TYPELIB_WIN64_PATH = @"SOFTWARE\Classes\Typelib\{8cec5860-07a1-11d9-b15e-000d56bfe6ee}\1.0\0\win64";
        internal const string _336_DEFAULT_KEYBOARD_PATH = @".DEFAULT\Control Panel\Keyboard";
        internal const string _336_DISABLED_VALUE = "2147483648";
        internal const string _336_ENABLED_VALUE = "2147483650";
        internal const string _336_INITIAL_INDICATORS = "InitialKeyboardIndicators";
        internal const string _337_KEYBOARD_LAYOUT_PATH = @"SYSTEM\CurrentControlSet\Control\Keyboard Layout";
        internal const string _337_SCAN_CODE = "Scancode Map";
        internal const string _338_DISABLED_VALUE = "506";
        internal const string _338_ENABLED_VALUE = "510";
        internal const string _338_FLAGS = "Flags";
        internal const string _338_STICKY_KEYS_PATH = @"Control Panel\Accessibility\StickyKeys";
        internal const string _339_AUTOPLAY = "DisableAutoplay";
        ...
        internal const byte _340_ENABLED_VALUE = 3;
        ...
        internal const string _340_THUMBNAIL_CACHE_PATH = @"SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Explorer\VolumeCaches\Thumbnail Cache";
        internal const string _341_RESTART_APPS = "RestartApps";
        internal const string _342_FILE_PRINTER_SHARING_GROUP = "@FirewallAPI.dll,-32752";
        internal const string _342_NET_CATEGORY_PARAM = "NetworkCategory";
        internal const string _342_NETWORK_DISCOVERY_GROUP = "@FirewallAPI.dll,-28502";
        internal const string _342_PRIVATE_VALUE = "Private";
        internal const string _342_SET_PROFILE_PS = "Set-NetConnectionProfile";
        internal const string _343_ACTIVE_HOURS = "SmartActiveHoursState";
        ...
        internal const string _349_VC_REDISTRX64 = "vc_redist.x64.exe";
        internal const string _349_VC_REDISTRX64_ARGS = "/install /passive /norestart";
...
[Windows.UI.Notifications.ToastNotificationManager]::CreateToastNotifier(""""""windows.immersivecontrolpanel_cw5n1h2txyewy!microsoft.windows.immersivecontrolpanel"""""").Show($ToastMessage)";
        ...
        internal const string _700_WINDOWS_CLEANUP_COMMAND = @"powershell.exe -Command ""& {Start-ScheduledTask -TaskPath 'ERSSettings' -TaskName 'Windows Cleanup'}"" -Force";
